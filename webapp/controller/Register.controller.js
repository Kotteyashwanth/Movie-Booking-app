    ...
    return Controller.extend("project1.controller.Register", {
        ...
        onSignUp: async function () {
            ...
            if (!isStrongPassword(sPassword)) {
                oModel.setProperty("/message", "Password must contain uppercase, lowercase, number and symbol");
                return;
            }

            if (!sConfirmPassword) {
                oModel.setProperty("/message", "Please confirm password");
                return;
            }
            ...
            try {
                ...
                oModel.setProperty("/message", e.message);
            }
        },
